    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <form action="/delete-multi" method="POST" class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
                    @csrf
                    <button type="submit"
                        class="mb-4 inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                        Delete Selected
                    </button>
